"use client";
import { Layer, PoultryVaccination, PoultryFeedManagement, PoultryWaterManagement } from "@/types/animals";
...
export default function PoultryHealthTables({
    ...
    const [vaccinations, setVaccinations] = useState<PoultryVaccination[]>(animal.vaccinations || []);
    const [feed, setFeed] = useState<PoultryFeedManagement[]>(animal.feedManagement || []);
    const [water, setWater] = useState<PoultryWaterManagement[]>(animal.waterManagement || []);
