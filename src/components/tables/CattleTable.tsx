...
export default function CattleTable() {
  ...
  // Filter only cattle with valid _id
  type CattleWithId = Cattle & { _id: string };

  const cattleOnly = animals.filter(
    (a): a is CattleWithId =>
      a.species === "Cattle" && typeof a._id === "string"
  );
              ...
              {filteredCattle.length > 0 ? (
                filteredCattle.map((animal, idx) => (
                  ...
                  >
                    ...
                    <td className="py-1 px-1 md:py-2 md:px-4 border border-gray-300 whitespace-nowrap">
                      {formatDate(animal.reproduction?.[0]?.lastAiDate)}
                    </td>
                    ...
                    <td className="py-1 px-1 md:py-2 md:px-4 border border-gray-300 whitespace-nowrap">
                      {formatDate(animal.reproduction?.[0]?.expectedCalvingDate)}
                    </td>
            ...
            filteredCattle.map((animal) => (
              ...
              >
                ...
                <p className="text-xs text-gray-600">
                  Last AI Date: {formatDate(animal.reproduction?.[0]?.lastAiDate)}
                </p>
